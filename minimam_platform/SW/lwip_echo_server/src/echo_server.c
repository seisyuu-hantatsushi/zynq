...
#if LWIP_IPV6==1
static void print_ip6(char *msg, ip_addr_t *ip)
{
	print(msg);
...
static const uint32_t default_ipv4_addr = LWIP_MAKEU32(192, 168, 10, 91);
static const uint32_t default_ipv4_netmask = LWIP_MAKEU32(255, 255, 255, 0);
static const uint32_t default_ipv4_gw = LWIP_MAKEU32(192, 168, 10, 1);
