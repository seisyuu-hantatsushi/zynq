...
#
# create_project.tcl: Tcl script for re-creating project 'hello_world'
#
# Generated by Vivado on Sat Nov 29 10:02:21 JST 2025
...
set orig_proj_dir "[file normalize "$origin_dir/../hello_world"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../hello_world/hello_world.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
